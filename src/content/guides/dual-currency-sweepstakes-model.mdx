...
figures:
  - id: gambling-test-venn
    src: /images/guides/sweepstakes-casino-gambling-test-venn.svg
    alt: "Gambling requires prize plus chance plus consideration; sweepstakes remove consideration via a free AMOE entry method."
    caption: "Why sweepstakes casinos sit outside gambling law in most states: the AMOE arrow removes the consideration element. Source: SweepstakesWiz Dual-Currency Model, July 2026."
---
...
1. Our [state guide hub](/state-legality/) for your jurisdiction
