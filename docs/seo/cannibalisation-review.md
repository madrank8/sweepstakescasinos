...
|---|---|---|---|
| `/` from `src/routes/index.astro` | `Best Sweepstakes Casinos: 4 Resolved Editor Picks \| Sweepstakes Wiz` | Concise answer, four supported editor picks, and a deterministic facts-first comparison for initial decisions. | DISTINCT |
