...
| Fastest payout sweepstakes casinos | freshness | FAIL | lastVerifiedDate current count: 0/29; 0/29 records have a verified lastVerifiedDate. |
...
| Most free Sweeps Coins | freshness | FAIL | lastVerifiedDate current count: 0/29; 0/29 records have a verified lastVerifiedDate. |
...
- **DEFER: Fastest payout sweepstakes casinos.** Unmet gates: canonical field coverage: 17/29 records have verified published timing text, but 0 have a normalized comparable payout-duration metric; freshness: lastVerifiedDate current count: 0/29; 0/29 records have a verified lastVerifiedDate.
- **DEFER: Most free Sweeps Coins.** Unmet gates: canonical field coverage: 26/29 records have a verified signup offer; freshness: lastVerifiedDate current count: 0/29; 0/29 records have a verified lastVerifiedDate; distinct intent: The intent is already served by /bonuses/no-deposit/; competing URLs: /bonuses/no-deposit/ is the existing canonical no-purchase offer destination.
